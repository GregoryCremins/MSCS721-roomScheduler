...
public class ExportRoomTest {
	...
	String[] arguments = new String[]{"1 TestRoom 12 5 6 Testfile.json 0"};
	...
	public void test() 
	{
		...
		boolean roomCreatedTest = outResults.toString().contains("TestRoom - 12") && outResults.toString().contains("Files exported to Testfile.json");
		if(roomCreatedTest)
		{
